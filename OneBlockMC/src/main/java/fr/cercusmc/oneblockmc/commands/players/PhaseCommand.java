...
import fr.cercusmc.oneblockmc.menus.PhaseMenu;
...
public class PhaseCommand implements SubCommand {
	...
	public List<String> getAliases() {
		return new ArrayList<>(Arrays.asList("phase"));
	}
	...
	public void perform(CommandSender sender, String[] args) {
		...
		try {
			MenuManager.openMenu(PhaseMenu.class, p);
